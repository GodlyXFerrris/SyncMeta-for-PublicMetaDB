...
class WebTests(unittest.TestCase):
    ...
    def test_index_contains_new_source_sections(self) -> None:
        ...
        self.assertIn("only imports items that are not already watched in PublicMetaDB", html)
        self.assertIn("only when you run them from the dashboard buttons", html)
